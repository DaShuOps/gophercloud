...
type QueryOrderDetaiResp struct {
	//Status code.
	ErrorCode string `json:"error_code"`
...
func (r QueryOrderDetailResult) Extract() (*QueryOrderDetaiResp, error) {
	var res *QueryOrderDetaiResp
	err := r.ExtractInto(&res)
	return res, err
}
...
func (r QueryResourceStatusByOrderIdResult) Extract() (*QueryResourceStatusByOrderIdResp, error) {
