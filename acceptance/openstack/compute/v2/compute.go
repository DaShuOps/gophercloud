...
import (
	...
	"github.com/DashuOps/gophercloud/acceptance/clients"
	"github.com/DashuOps/gophercloud/acceptance/tools"
	"github.com/DashuOps/gophercloud/openstack/blockstorage/v1/volumes"
	"github.com/DashuOps/gophercloud/openstack/compute/v2/extensions/bootfromvolume"
	dsr "github.com/DashuOps/gophercloud/openstack/compute/v2/extensions/defsecrules"
	"github.com/DashuOps/gophercloud/openstack/compute/v2/extensions/floatingips"
	"github.com/DashuOps/gophercloud/openstack/compute/v2/extensions/keypairs"
	"github.com/DashuOps/gophercloud/openstack/compute/v2/extensions/networks"
	"github.com/DashuOps/gophercloud/openstack/compute/v2/extensions/quotasets"
	"github.com/DashuOps/gophercloud/openstack/compute/v2/extensions/schedulerhints"
	"github.com/DashuOps/gophercloud/openstack/compute/v2/extensions/secgroups"
	"github.com/DashuOps/gophercloud/openstack/compute/v2/extensions/servergroups"
	"github.com/DashuOps/gophercloud/openstack/compute/v2/extensions/tenantnetworks"
	"github.com/DashuOps/gophercloud/openstack/compute/v2/extensions/volumeattach"
	"github.com/DashuOps/gophercloud/openstack/compute/v2/flavors"
	"github.com/DashuOps/gophercloud/openstack/compute/v2/servers"

	"github.com/DashuOps/gophercloud/openstack/compute/v2/extensions/aggregates"
